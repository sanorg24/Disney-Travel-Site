...
- **Sveltia's `reorder` and `view_groups` collection options do not work reliably in this setup**
  ...
  actually been fixed upstream. `sortable_fields` (a plain default-sort setting, not drag) is the
